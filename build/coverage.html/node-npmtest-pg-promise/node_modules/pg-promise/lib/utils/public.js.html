...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pg-promise/node_modules/pg-promise/lib/utils/public.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pg-promise/node_modules/pg-promise/lib/utils/public.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pg-promise/node_modules/pg-promise/lib/utils/</a> &#187; public.js</div>
</div>
<div class="body">
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function camelize(text) {</span>
<span class="cstat-no" title="statement not covered" >    text = text.replace(/[\-_\s\.]+(.)?/g, (match, chr) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return chr ? chr.toUpperCase() : '';</span>
    });
<span class="cstat-no" title="statement not covered" >    return text.substr(0, 1).toLowerCase() + text.substr(1);</span>
}
&nbsp;
/**
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function camelizeVar(text) {</span>
<span class="cstat-no" title="statement not covered" >    text = text.replace(/[^a-zA-Z0-9\$_\-\s\.]/g, '').replace(/^[0-9_\-\s\.]+/, '');</span>
<span class="cstat-no" title="statement not covered" >    return camelize(text);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function _enumSql(dir, options, cb, namePath) {</span>
<span class="cstat-no" title="statement not covered" >    var tree = {};</span>
<span class="cstat-no" title="statement not covered" >    $npm.fs.readdirSync(dir).forEach(file =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        var stat, fullPath = $npm.path.join(dir, file);</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >            stat = $npm.fs.statSync(fullPath);</span>
        } catch (e) {
...
<span class="cstat-skip" title="statement not covered" >            if (options.ignoreErrors) {</span>
<span class="cstat-skip" title="statement not covered" >                return; </span>// on to the next file/folder;
            }
            // istanbul ignore next
...
<span class="cstat-no" title="statement not covered" >                var dirName = camelizeVar(file);</span>
<span class="cstat-no" title="statement not covered" >                var np = namePath ? (namePath + '.' + dirName) : dirName;</span>
<span class="cstat-no" title="statement not covered" >                var t = _enumSql(fullPath, options, cb, np);</span>
<span class="cstat-no" title="statement not covered" >                if (Object.keys(t).length) {</span>
<span class="cstat-no" title="statement not covered" >                    if (!dirName.length || dirName in tree) {</span>
<span class="cstat-no" title="statement not covered" >                        if (!options.ignoreErrors) {</span>
<span class="cstat-no" title="statement not covered" >                            throw new Error('Empty or duplicate camelized folder name: ' + fullPath);</span>
                        }
                    }
<span class="cstat-no" title="statement not covered" >                    tree[dirName] = t;</span>
                }
            }
        } else {
<span class="cstat-no" title="statement not covered" >            if ($npm.path.extname(file).toLowerCase() === '.sql') {</span>
<span class="cstat-no" title="statement not covered" >                var name = camelizeVar(file.replace(/\.[^/.]+$/, ''));</span>
<span class="cstat-no" title="statement not covered" >                if (!name.length || name in tree) {</span>
<span class="cstat-no" title="statement not covered" >                    if (!options.ignoreErrors) {</span>
<span class="cstat-no" title="statement not covered" >                        throw new Error('Empty or duplicate camelized file name: ' + fullPath);</span>
                    }
                }
<span class="cstat-no" title="statement not covered" >                tree[name] = fullPath;</span>
<span class="cstat-no" title="statement not covered" >                if (cb) {</span>
<span class="cstat-no" title="statement not covered" >                    var result = cb(fullPath, name, namePath ? (namePath + '.' + name) : name);</span>
<span class="cstat-no" title="statement not covered" >                    if (result !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >                        tree[name] = result;</span>
                    }
                }
            }
        }
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function enumSql(dir, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    if (!$npm.utils.isText(dir)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new TypeError('Parameter \'dir\' must be a non-empty text string.');</span>
    }
...
<span class="cstat-no" title="statement not covered" >    return _enumSql(dir, options, cb, '');</span>
}
&nbsp;
/**
 *
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function objectToCode(obj, cb) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!obj || typeof obj !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >        throw new TypeError('Parameter \'obj\' must be a non-null object.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    cb = (typeof cb === 'function') ? cb : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return '{' + generate(obj, 1) + EOL + '}';</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function generate(obj, level) {</span>
<span class="cstat-no" title="statement not covered" >        var code = '', gap = $npm.utils.messageGap(level);</span>
...
<span class="cstat-no" title="statement not covered" >                code += EOL + gap + prop + ': {';</span>
<span class="cstat-no" title="statement not covered" >                code += generate(value, level + 1);</span>
<span class="cstat-no" title="statement not covered" >                code += EOL + gap + '}';</span>
            } else {
<span class="cstat-no" title="statement not covered" >                code += EOL + gap + prop + ': ';</span>
<span class="cstat-no" title="statement not covered" >                if (cb) {</span>
<span class="cstat-no" title="statement not covered" >                    code += cb(value, prop, obj);</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    code += JSON.stringify(value);</span>
                }
            }
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function buildSqlModule(config) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if ($npm.utils.isText(config)) {</span>
<span class="cstat-no" title="statement not covered" >        var path = $npm.utils.isPathAbsolute(config) ? config : $npm.path.join($npm.utils.startDir, config);</span>
<span class="cstat-no" title="statement not covered" >        config = require(path);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        if ($npm.utils.isNull(config)) {</span>
<span class="cstat-no" title="statement not covered" >            var defConfig = $npm.path.join($npm.utils.startDir, 'sql-config.json');</span>
            // istanbul ignore else;
<span class="cstat-no" title="statement not covered" >            if (!$npm.fs.existsSync(defConfig)) {</span>
<span class="cstat-no" title="statement not covered" >                throw new Error('Default SQL configuration file not found: ' + defConfig);</span>
            }
            ...
            // istanbul ignore next;
<span class="cstat-skip" title="statement not covered" >            config = require(defConfig);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            if (!config || typeof config !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >                throw new TypeError('Invalid parameter \'config\' specified.');</span>
            }
        }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!$npm.utils.isText(config.dir)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Property \'dir\' must be a non-empty string.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var total = 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var tree = enumSql(config.dir, {recursive: config.recursive, ignoreErrors: config.ignoreErrors}, () =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        total++;</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    var modulePath = './loadSql', moduleName = 'load';</span>
<span class="cstat-no" title="statement not covered" >    if (config.module &amp;&amp; typeof config.module === 'object') {</span>
<span class="cstat-no" title="statement not covered" >        if ($npm.utils.isText(config.module.path)) {</span>
<span class="cstat-no" title="statement not covered" >            modulePath = config.module.path;</span>
        }
<span class="cstat-no" title="statement not covered" >        if ($npm.utils.isText(config.module.name)) {</span>
<span class="cstat-no" title="statement not covered" >            moduleName = config.module.name;</span>
        }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var header =</span>
        ...
        'module.exports = ';
&nbsp;
<span class="cstat-no" title="statement not covered" >    var code = header + objectToCode(tree, value =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            return moduleName + '(' + JSON.stringify(value) + ')';</span>
        }) + ';';
&nbsp;
<span class="cstat-no" title="statement not covered" >    if ($npm.utils.isText(config.output)) {</span>
<span class="cstat-no" title="statement not covered" >        var p = config.output;</span>
<span class="cstat-no" title="statement not covered" >        if (!$npm.utils.isPathAbsolute(p)) {</span>
<span class="cstat-no" title="statement not covered" >            p = $npm.path.join($npm.utils.startDir, p);</span>
        }
<span class="cstat-no" title="statement not covered" >        $npm.fs.writeFileSync(p, code);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return code;</span>
}
