...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pg-promise/node_modules/pg-promise/lib/main.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pg-promise/node_modules/pg-promise/lib/main.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pg-promise/node_modules/pg-promise/lib/</a> &#187; main.js</div>
</div>
<div class="body">
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function $main(options) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            throw new TypeError('Invalid initialization options.');</span>
        }
&nbsp;
        // list of supported initialization options:
<span class="cstat-no" title="statement not covered" >        var validOptions = ['pgFormatting', 'pgNative', 'promiseLib', 'noLocking', 'capSQL', 'noWarnings',</span>
            'connect', 'disconnect', 'query', 'receive', 'task', 'transact', 'error', 'extend'];
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!options.noWarnings) {</span>
<span class="cstat-no" title="statement not covered" >            for (var prop in options) {</span>
<span class="cstat-no" title="statement not covered" >                if (validOptions.indexOf(prop) === -1) {</span>
<span class="cstat-no" title="statement not covered" >                    $npm.con.warn('WARNING: Invalid property \'%s\' in initialization options.\n%s\n', prop, $npm.utils.getLocalStack(3));</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var pg = $npm.pg, p = $npm.promise(options.promiseLib);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProp(config, '$npm', {}, true);</span>
&nbsp;
    // Locking properties that cannot be changed later:
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProp(options, 'promiseLib', options.promiseLib);</span>
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProp(options, 'pgNative', !!options.pgNative);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    config.options = options;</span>
&nbsp;
    // istanbul ignore next:
    // we do not cover code specific to Native Bindings
<span class="cstat-skip" title="statement not covered" >    if (options.pgNative) {</span>
<span class="cstat-skip" title="statement not covered" >        pg = $npm.pg.native;</span>
<span class="cstat-skip" title="statement not covered" >        if ($npm.utils.isNull(pg)) {</span>
<span class="cstat-skip" title="statement not covered" >            throw new Error('Failed to initialize Native Bindings.');</span>
        }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var Database = require('./database')(config);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var inst = (cn, dc) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if ($npm.utils.isText(cn) || (cn &amp;&amp; typeof cn === 'object')) {</span>
<span class="cstat-no" title="statement not covered" >            return new Database(cn, dc, config);</span>
        }
<span class="cstat-no" title="statement not covered" >        throw new TypeError('Invalid connection details.');</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProperties(inst, rootNameSpace);</span>
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProp(inst, 'pg', pg);</span>
&nbsp;
    /**
     * @member {function} end
     * @readonly
     ...
     */
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProp(inst, 'end', () =&gt; {</span>
...
&nbsp;
     ...
     * @see {@link helpers}.
     */
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProp(inst, 'helpers', $npm.helpers(config));</span>
&nbsp;
    /**
     ...
     * {@link Task.sequence}
     */
<span class="cstat-no" title="statement not covered" >    $npm.utils.addReadProp(inst, 'spex', config.$npm.spex);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    config.pgp = inst;</span>
<span class="cstat-no" title="statement not covered" >    Object.freeze(config);</span>
&nbsp;
