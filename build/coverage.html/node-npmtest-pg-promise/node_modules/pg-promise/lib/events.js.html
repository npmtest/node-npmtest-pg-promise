...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pg-promise/node_modules/pg-promise/lib/events.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pg-promise/node_modules/pg-promise/lib/events.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pg-promise/node_modules/pg-promise/lib/</a> &#187; events.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        if (typeof ctx.options.connect === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                ctx.options.connect(client, ctx.dc, isFresh);</span>
            } catch (e) {
...
<span class="cstat-no" title="statement not covered" >                $events.unexpected('connect', e);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (typeof ctx.options.disconnect === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                ctx.options.disconnect(client, ctx.dc);</span>
            } catch (e) {
                // have to silence errors here;
                // cannot allow unhandled errors while disconnecting from the database,
                // as it will break the disconnection logic;
<span class="cstat-no" title="statement not covered" >                $events.unexpected('disconnect', e);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (typeof options.query === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                options.query(context);</span>
            } catch (e) {
                // throwing an error during event 'query'
                // will result in a reject for the request.
<span class="cstat-no" title="statement not covered" >                return e instanceof Error ? e : new $npm.utils.InternalError(e);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (typeof options.receive === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                options.receive(data, result, context);</span>
            } catch (e) {
...
<span class="cstat-no" title="statement not covered" >        if (typeof options.task === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                options.task(context);</span>
            } catch (e) {
                // silencing the error, to avoid breaking the task;
<span class="cstat-no" title="statement not covered" >                $events.unexpected('task', e);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (typeof options.transact === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                options.transact(context);</span>
            } catch (e) {
                // silencing the error, to avoid breaking the transaction;
<span class="cstat-no" title="statement not covered" >                $events.unexpected('transact', e);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                options.error(err, context);</span>
            } catch (e) {
                // have to silence errors here;
                // throwing unhandled errors while handling an error
                // notification is simply not acceptable.
<span class="cstat-no" title="statement not covered" >                $events.unexpected('error', e);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (typeof options.extend === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                options.extend.call(obj, obj, dc);</span>
            } catch (e) {
                // have to silence errors here;
                // the result of throwing unhandled errors while
                // extending the protocol would be unpredictable.
<span class="cstat-no" title="statement not covered" >                $events.unexpected('extend', e);</span>
            }
        }
    },
&nbsp;
...
&nbsp;
        /* istanbul ignore if */
<span class="cstat-no" title="statement not covered" >        if (!$npm.main.suppressErrors) {</span>
<span class="cstat-skip" title="statement not covered" >            var stack = e instanceof Error ? e.stack : new Error().stack;</span>
<span class="cstat-skip" title="statement not covered" >            $npm.con.error('Unexpected error in \'%s\' event handler.\n%s\n', event, stack);</span>
        }
    }
};
&nbsp;
