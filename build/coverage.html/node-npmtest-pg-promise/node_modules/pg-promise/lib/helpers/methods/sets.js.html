...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/methods/sets.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/methods/sets.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/methods/</a> &#187; sets.js</div>
</div>
<div class="body">
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function sets(data, columns) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!data || typeof data !== 'object' || Array.isArray(data)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return $npm.format(columns.assign(data), columns.prepare(data));</span>
}
&nbsp;
module.exports = sets;
&nbsp;
