...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/methods/update.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/methods/update.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/methods/</a> &#187; update.js</div>
</div>
<div class="body">
 ...
 * }
 */
<span class="fstat-no" title="function not covered" >function update(data, columns, table, options, capSQL) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!data || typeof data !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >        throw new TypeError('Invalid parameter \'data\' specified.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var isArray = Array.isArray(data);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isArray &amp;&amp; !data.length) {</span>
<span class="cstat-no" title="statement not covered" >        throw new TypeError('Cannot generate an UPDATE from an empty array.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (columns instanceof $npm.ColumnSet) {</span>
<span class="cstat-no" title="statement not covered" >        if ($npm.utils.isNull(table)) {</span>
<span class="cstat-no" title="statement not covered" >            table = columns.table;</span>
        }
    } else {
<span class="cstat-no" title="statement not covered" >        if (isArray &amp;&amp; $npm.utils.isNull(columns)) {</span>
<span class="cstat-no" title="statement not covered" >            throw new TypeError('Parameter \'columns\' is required when updating multiple records.');</span>
        }
<span class="cstat-no" title="statement not covered" >        columns = new $npm.ColumnSet(columns || data);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    options = options || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var format = $npm.formatting.as.format,</span>
        useEmptyUpdate = 'emptyUpdate' in options;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isArray) {</span>
<span class="cstat-no" title="statement not covered" >        var tableAlias = 't', valueAlias = 'v';</span>
<span class="cstat-no" title="statement not covered" >        if ($npm.utils.isText(options.tableAlias)) {</span>
<span class="cstat-no" title="statement not covered" >            tableAlias = options.tableAlias;</span>
        }
<span class="cstat-no" title="statement not covered" >        if ($npm.utils.isText(options.valueAlias)) {</span>
<span class="cstat-no" title="statement not covered" >            valueAlias = options.valueAlias;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        var q = capSQL ? sql.multi.capCase : sql.multi.lowCase;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var actualColumns = $arr.filter(columns.columns, c =&gt; <span class="cstat-no" title="statement not covered" >!c.cnd)</span>;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (checkColumns(actualColumns)) {</span>
<span class="cstat-no" title="statement not covered" >            return options.emptyUpdate;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        checkTable();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var targetCols = $arr.map(actualColumns, c =&gt; <span class="cstat-no" title="statement not covered" >c.escapedName + '=' + valueAlias + '.' + c.escapedName)</span>.join();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var values = $arr.map(data, (d, index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (!d || typeof d !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >                throw new Error('Invalid update object at index ' + index + '.');</span>
            }
<span class="cstat-no" title="statement not covered" >            return '(' + format(columns.variables, columns.prepare(d)) + ')';</span>
        }).join();
&nbsp;
<span class="cstat-no" title="statement not covered" >        return format(q, [table.name, tableAlias, targetCols, values, valueAlias, columns.names]);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var updates = columns.assign(data);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (checkColumns(updates)) {</span>
<span class="cstat-no" title="statement not covered" >        return options.emptyUpdate;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    checkTable();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var query = capSQL ? sql.single.capCase : sql.single.lowCase;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return format(query, table.name) + format(updates, columns.prepare(data));</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkTable() {</span>
<span class="cstat-no" title="statement not covered" >        if (table &amp;&amp; !(table instanceof $npm.TableName)) {</span>
<span class="cstat-no" title="statement not covered" >            table = new $npm.TableName(table);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (!table) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('Table name is unknown.');</span>
        }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkColumns(cols) {</span>
<span class="cstat-no" title="statement not covered" >        if (!cols.length) {</span>
<span class="cstat-no" title="statement not covered" >            if (useEmptyUpdate) {</span>
<span class="cstat-no" title="statement not covered" >                return true;</span>
            }
<span class="cstat-no" title="statement not covered" >            throw new Error('Cannot generate an UPDATE without any columns.');</span>
        }
    }
}
&nbsp;
