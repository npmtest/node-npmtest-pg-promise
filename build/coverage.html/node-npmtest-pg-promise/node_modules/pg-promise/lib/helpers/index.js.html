...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pg-promise/node_modules/pg-promise/lib/helpers/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            var capSQL = config.options &amp;&amp; config.options.capSQL;</span>
<span class="cstat-no" title="statement not covered" >            return $npm.insert(data, columns, table, capSQL);</span>
        },
        update: (data, columns, table, options) =&gt; {
<span class="cstat-no" title="statement not covered" >            var capSQL = config.options &amp;&amp; config.options.capSQL;</span>
<span class="cstat-no" title="statement not covered" >            return $npm.update(data, columns, table, options, capSQL);</span>
        },
        concat: $npm.concat,
        values: $npm.values,
        sets: $npm.sets,
...
<span class="cstat-no" title="statement not covered" >    Object.freeze(res);</span>
