...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pg-promise/node_modules/pg-promise/lib/errors/queryResult.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pg-promise/node_modules/pg-promise/lib/errors/queryResult.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pg-promise/node_modules/pg-promise/lib/errors/</a> &#187; queryResult.js</div>
</div>
<div class="body">
 ...
 *
 */
<span class="fstat-no" title="function not covered" >function QueryResultError(code, result, query, values) {</span>
<span class="cstat-no" title="statement not covered" >    var temp = Error.apply(this, arguments);</span>
<span class="cstat-no" title="statement not covered" >    temp.name = this.name = 'QueryResultError';</span>
<span class="cstat-no" title="statement not covered" >    this.stack = temp.stack;</span>
<span class="cstat-no" title="statement not covered" >    this.message = errorMessages[code].message;</span>
...
<span class="cstat-no" title="statement not covered" >    this.received = result.rows.length;</span>
}
&nbsp;
 ...
 * @returns {string}
 */
QueryResultError.prototype.toString = <span class="fstat-no" title="function not covered" >function (level) {</span>
...
<span class="cstat-no" title="statement not covered" >        lines.push(gap1 + 'values: ' + JSON.stringify(this.values));</span>
    }
...
&nbsp;
QueryResultError.prototype.inspect = <span class="fstat-no" title="function not covered" >function () {</span>
